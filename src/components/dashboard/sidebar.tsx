...
import { LayoutDashboard, BookOpen, CreditCard, LogOut, Settings, ChevronRight, BarChart2 } from "lucide-react";
import { ClicmenuLogo, ClicmenuIcon } from "@/components/ui/logo";
...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 flex-shrink-0 flex flex-col h-screen sticky top-0 bg-white border-r border-slate-100">
      {/* ── Logo ──────────────────────────────────────── */}
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-emerald-50 text-emerald-700 nav-active-indicator"
